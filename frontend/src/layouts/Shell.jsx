...
const NAV = {
  platform_admin: [['Dashboard', '/admin', 'dash'], ['Applications', '/admin/applications', 'inbox'], ['Hospitals', '/admin/hospitals', 'hosp'], ['Doctors', '/admin/doctors', 'doc'], ['Patients', '/admin/patients', 'users'], ['Appointments', '/admin/appointments', 'cal'], ['AI Activity', '/admin/ai', 'chat'], ['Integrations', '/admin/integrations', 'pulse'], ['Reconciliation', '/admin/reconciliation', 'shield'], ['Workflows', '/admin/workflows', 'gear'], ['Analytics', '/admin/analytics', 'chart'], ['Audit', '/admin/audit', 'clip'], ['Ops Health', '/admin/ops', 'pulse']],
  hospital_admin: [['Dashboard', '/hospital', 'dash'], ['Doctors', '/hospital/doctors', 'doc'], ['Schedules', '/hospital/schedules', 'cal'], ['Appointments', '/hospital/appointments', 'clip'], ['Questionnaires', '/hospital/questionnaires', 'clip'], ['AI Activity', '/hospital/ai', 'chat'], ['Integrations', '/hospital/integrations', 'pulse'], ['Workflows', '/hospital/workflows', 'gear'], ['Notifications', '/hospital/notifications', 'bell'], ['Analytics', '/hospital/analytics', 'chart'], ['Audit', '/hospital/audit', 'shield']],
